...
//        }
        ...
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "112 ; 0.05 ; 26 ; 25 ; 66 ; 0.85 ; 65 ; 1.2 ; 2029 ; 1", true);
        }
        ...
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "219 ; 1 ; 387 ; 35 ; 398 ; 15 ; 116 ; 6 ; 393 ; 0 ; 390 ; 1.635 ; 1 ; 0.523", true);
        }
        case 730: // Beggar's Bazooka
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "394 ; 1 ; 413 ; 1 ; 411 ; 3 ; 97 ; 0.75 ; 394 ; 0.30 ; 4 ; 5.0 ; 1 ; 0.85 ; 76 ; 2.5", true);
        }
        case 811: // Huo Long Heatmaker
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "430 ; 1 ; 431 ; 3 ; 1 ; 0.85 ; 76 ; 1.25 ; 15 ; 0 ; 236 ; 1 ; 421 ; 1 ; 208 ; 1", true);
        }
        case 41: // NAT
        {
        ...
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "2 ; 1.2 ; 54 ; 0.85 ; 26 ; 80", true);
        }
        case 142: // Gunslinger
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "113 ; 5.0 ; 2049 ; 1 ; 124 ; 1 ; 26 ; 25 ; 464 ; 4.5 ; 15 ; 0 ; 292 ; 3 ; 293 ; 0 ; 107 ; 1.2", true);
        }
        case 171: // Shiv
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "236 ; 1 ; 275 ; 1 ; 1 ; 0.50", true);
        }
        case 59: // Dead Ringer
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "33 ; 1 ; 83 ; 0.6 ; 726 ; 0.5 ; 35 ; 1.5 ; 810 ; 1", true);
        }
        case 304: // Amputator
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "1 ; 0.20 ; 551 ; 1", true);
        }
//        case 153, 466: // Homewrecker + Maul
//        {
//            hItemOverride = PrepareItemHandle(hItem, _, _, "182 ; 6 ; 1 ; 0.70", true);
//        }
        ...
        case 349: // Sun
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "1 ; 0.75 ; 208 ; 1 ; 26 ; 25", true);
        }
        case 327: // MOH
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "551 ; 1 ; 26 ; 5 ; 202 ; 2.5", true);
        }
        case 404: // Persian Persuader
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "551 ; 1 ; 26 ; 5 ; 107 ; 1.20", true);
        }
        case 132, 266, 1082, 482: // Eyelander
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "1 ; 0.70 ; 781 ; 72 ; 15 ; 0 ; 125 ; -25 ; 219 ; 1 ; 292 ; 6 ; 388 ; 6 ; 551 ; 1", true);
        }
        case 228, 1085: // BOX OF COX
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "3 ; 0.75 ; 328 ; 1 ; 16 ; 30", true);
        }
        case 772: // Baby Face's Blaster
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "3 ; 0.66", true);
        }
        case 1104: // Air Strike
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "100 ; 0.90 ; 1 ; 0.85 ; 135 ; 0.85 ; 621 ; 0.35 ; 642 ; 1 ; 644 ; 4 ; 328 ; 1 ; 112 ; 0.05 ; 76 ; 1.50", true);
        }
        case 141, 1004: // Frontier Justice
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "136 ; 1 ; 15 ; 0 ; 3 ; 0.5 ; 551 ; 1 ; 97 ; 0.50", true);
        }
        case 402: // Bazaar
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "1 ; 0.523 ; 90 ; 1.40", true);
        }
//        case 482: // Nessie
//        {
//            hItemOverride = PrepareItemHandle(hItem, _, _, "125 ; -25 ; 219 ; 1 ; 292 ; 6 ; 388 ; 6 ; 551 ; 1 ; 15 ; 0 ; 5 ; 1.25", true);
//        }
        case 154: // Pain Train
        {
        ...
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "298 ; 3 ; 300 ; 1 ; 301 ; 1 ; 303 ; 1 ; 307 ; 1 ; 15 ; 0 ; 312 ; 1", true);
        }
        case 751: // Cleaner's Carbine
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "32 ; 0.35 ; 5 ; 1.30 ; 3 ; 0.80 ; 106 ; 0.0", true);
        }
        ...
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "435 ; 1 ; 15 ; 0 ; 2029 ; 1", true);
        }
        case 14, 201, 664, 792, 801, 851, 881, 890, 899, 908, 957, 966: // Sniper Rifle
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "1 ; 0.61", true);
        }
        case 230: // Sleeper
        {
        ...
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "1 ; 0.647 ; 308 ; 1 ; 297 ; 1 ; 304 ; 1.15 ; 305 ; 1 ; 144 ; 2", true);
        }
        case 17, 204: // Syringegun
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "17 ; 0.05 ; 2 ; 1.80", true);
        }
        case 36: // Blutsauger
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "17 ; 0.01 ; 76 ; 1.6 ; 4 ; 1.5 ; 2 ; 1.65", true);
        }
        case 131, 1144: // Chargin' Targe
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "774 ; -0.35 ; 60 ; 0.5 ; 64 ; 0.7 ; 2029 ; 1", true);
        }
        case 412: // Overdose
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "17 ; 0.06 ; 6 ; 0.9 ; 314 ; -2 ; 2 ; 1.50", true);
        }
        case 37, 1003: // NOOBersaw
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "17 ; 0.25 ; 5 ; 1.2 ; 144 ; 1 ; 551 ; 1 ; 2 ; 1.10 ; 781 ; 72", true);
        }
        case 61, 1006: // Ambassador
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "51 ; 1 ; 1 ; 0.85 ; 5 ; 1.2 ; 15 ; 0", true); // 868 ; 1 - FALLOFF DIST NERF
        }
        case 593: // Third Degree
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "360 ; 1 ; 350 ; 1 ; 6 ; 0.70", true);
        }
        case 128: // Equalizer
        {
        ...
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "783 ; 20 ; 2 ; 1.15 ; 841 ; 0 ; 843 ; 12 ; 865 ; 50 ; 844 ; 2300 ; 839 ; 2.8 ; 862 ; 0.6 ; 863 ; 0.1", true);
        }
        case 741: // Flamethrower (Reskin 1)
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "783 ; 20 ; 2 ; 1.15 ; 841 ; 0 ; 843 ; 12 ; 865 ; 50 ; 844 ; 2300 ; 839 ; 2.8 ; 862 ; 0.6 ; 863 ; 0.1", true);
        }
        case 1098: // Classic
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "107 ; 1.20 ; 6 ; 0.85 ; 1 ; 0.466", true);
        }
        case 448: // SODA
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "97 ; 0.75 ; 6 ; 0.5 ; 3 ; 0.34 ; 43 ; 1 ; 77 ; 0.56", true);
        }
        case 4, 194, 638, 665, 727, 794, 803, 883, 892, 901, 910, 
             959, 968, 15080, 15094, 15095, 15096, 15118, 15119, 
             15143, 15144:                                                 	// DEFAULT MELEE WEAPONS BUFF (SPY)
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "6 ; 0.80", true);
        }
        case 8, 198: 														// DEFAULT MELEE WEAPONS BUFF (MEDIC)
        {
        ...
        case 221, 572, 999: // Bat (Reskin 1)
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "2 ; 1.20 ; 292 ; 7 ; 388 ; 7", true);
        }
        case 587: // Fists (Reskin 1)
        {
            hItemOverride = PrepareItemHandle(hItem, _, _, "2 ; 1.20 ; 309 ; 1", true);
        }
        case 169: // Golden Wrench
        {
